        ...
        <div className="methods-protocol">
          ...
          <section className="protocol-section" id="before-after">
            ...
            <div className="method-definition-grid two">
              <article><small>Event activity panel</small><strong>Rolling event starts by affected geography</strong><p>Multi-country events count once in every affected country, while global and EU27 aggregates count each unique event once. The chart offers 7- and 28-day windows and can overlay two to five countries for one selected attention topic.</p></article>
          ...
          <section className="protocol-section" id="decisions">
            ...
            <div className="decision-table">
              ...
              <div><strong>Require two events for country rankings</strong><p>Prevents a single extreme event estimate from being presented as a country-level pattern.</p><span className="status-chip active">In use</span></div>
